...
if (isset($_POST['simpan'])) {
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        if (!in_array($extFoto, $ext)) {
            ...
            $insert = mysqli_query($koneksi, "INSERT INTO level (level) VALUES
            ('$level')");
        }
    } else {
        $insert = mysqli_query($koneksi, "INSERT INTO level (level_kategori) VALUES
            ('$level')");
    }
...
if (isset($_POST['edit'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE level SET level_kategori='$level' WHERE id='$id'");
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="mb-3 row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="level" placeholder="Masukkan Kategori" required value="<?php echo isset($_GET['edit']) ? $rowEdit['level_kategori'] : '' ?>">
                                                </div>
                                                <div class="mb-3 mt-3">
