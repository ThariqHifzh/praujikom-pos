...
$queryUser = mysqli_query($koneksi, "SELECT category_product.nama_kategori, products.* FROM products LEFT JOIN category_product ON products.id_kategori = category_product.id");
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card bg-transparent border-1" style="backdrop-filter: blur(10px); box-shadow: 0 0 15px 5px blueviolet;">
                                    <div class="card-header fw-bold text-white" style="font-size: x-large;">Products</div>
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3" align="right">
                                            <a href="tambah-barang.php" class="btn btn-primary" style="border-radius: 20px">Tambah</a>
                                        </div>
                                        <?php endif ?>
                                        <table class="table table-bordered text-white">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-white">Nama Product</th>
                                            ...
                                            <tbody>
                                                ...
                                                while ($rowUser = mysqli_fetch_assoc($queryUser)): ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $rowUser['nama_barang'] ?></td>
                                                        <td><?php echo $rowUser['satuan'] ?></td>
                                                        <td><?php echo $rowUser['qty'] ?></td>
                                                        <td><?php echo "Rp. " . number_format($rowUser['harga']) ?></td>
                                                        <?php if ($_SESSION['id_level'] == 1) : ?>
                                                        <td>
                                                            <a class="btn btn-success btn-sm"
                                                                href="tambah-barang.php?edit=<?php echo $rowUser['id'] ?>"><span class="tf-icon bx bx-pencil"></a>

                                                            <a class="btn btn-danger btn-sm"
                                                                onclick="return confirm('Apakah Anda Yakin untuk Menghapus Data Ini?')"
                                                                href="user.php?delete=<?php echo $rowUser['id'] ?>"><span class="tf-icon bx bx-trash"></a>
                                                        </td>
                                                        <?php endif ?>
                                                    </tr>
                                                <?php endwhile ?>
