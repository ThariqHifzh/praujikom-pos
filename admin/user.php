...
$queryUser = mysqli_query($koneksi, "SELECT level.level_kategori, users.* FROM users LEFT JOIN level ON users.id_level = level.id");
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card bg-transparent border-1" style="backdrop-filter: blur(10px); box-shadow: 0 0 15px 5px blueviolet;">
                                    <div class="card-header fw-bold text-white" style="font-size: x-large;">Data User</div>
                                    <div class="card-body">
                                        <?php if(isset($_GET['hapus'])): ?>
                                            <div class="alert alert-primary" role="alert">Data berhasil dihapus</div>
                                        <?php endif ?>
                                            <div class="mb-3" align="right">
                                                <a href="tambah-user.php" class="btn btn-primary" style="border-radius: 20px">Tambah</a>
                                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $no++ ?></td>
                                                <td><?php echo $rowUser['level_kategori'] ?></td>
                                                <td><?php echo $rowUser['nama'] ?></td>
                                                <td><?php echo $rowUser['email'] ?></td>
                                                <td>
                                                    <a class="btn btn-success btn-sm"
                                                    href="tambah-user.php?edit=<?php echo $rowUser['id'] ?>"><span class="tf-icon bx bx-pencil"></a>
