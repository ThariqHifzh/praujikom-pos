            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card border-1 bg-transparent text-white" style="backdrop-filter: blur(10px); box-shadow: 0 0 15px 5px blueviolet;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3" align="right">
                                            <a href="tambah-level.php" class="btn btn-primary" style="border-radius: 20px">Tambah</a>
                                        </div>
                                        <table class="table table-bordered text-white">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($query)): ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td><?php echo $row['level_kategori'] ?></td>
                                                        <td>
                                                            <a class="btn btn-success btn-sm"
                                                                href="tambah-level.php?edit=<?php echo $row['id'] ?>"><span class="tf-icon bx bx-pencil"></a>

                                                            <a class="btn btn-danger btn-sm"
                                                                onclick="return confirm('Apakah Anda Yakin untuk Menghapus Data Ini?')"
                                                                href="level.php?delete=<?php echo $row['id'] ?>"><span class="tf-icon bx bx-trash"></a>
                                                        </td>
                                                    </tr>
                                                <?php endwhile ?>
                                            </tbody>
